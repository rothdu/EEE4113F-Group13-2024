...
\begin{tabularx}{\textwidth}{|p{0.07\textwidth} p{0.2\textwidth} X|}
    ...
    GA3 & Engineering Design & Chapter \ref{ch: mechanical} details the development of the housing for the Red-Winged Starling Nest Monitoring project. After engagement with project stakeholders, the user requirements, functional requirements and specifications were created and analysed, shown in section The source code for the firmware is available in the \href{https://github.com/rothdu/EEE4113F-Group13-2024}{project repository} on GitHub.   \\ \hline
