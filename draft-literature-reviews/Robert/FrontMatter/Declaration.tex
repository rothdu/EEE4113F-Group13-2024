...
\par\noindent\makebox[2.5in]{\includegraphics[width=0.3\linewidth]{signature-robert.png}}\hfill\makebox[2.0in]{\today}%
\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%
\par\noindent\makebox[2.5in][l]{Robert Dugmore}      \hfill\makebox[2.0in][l]{Date}%
